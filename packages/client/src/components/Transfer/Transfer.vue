<template>
    <div class="Transfer">
        <el-dialog title="New transfer" :visible.sync="visible" @close="handleClose()" ref="dialog">
            <div v-if="step === 1">
                <el-form :model="form" ref="form" v-loading="true">
                    ...
                    <el-form-item label="Name" :label-width="labelWidth">
                        <el-input v-model="form.name" autocomplete="off" :disabled="isChoose"></el-input>
                    </el-form-item>
                ...
                <span slot="footer" class="dialog-footer">
                    ...
                    <el-button type="submit" @click="nextStep()">Next</el-button>
                </span>
            </div>
            ...
            <div v-if="step === 3">
                ...
                <el-form :model="form" ref="form">
                    <el-form-item label="Account Number" :label-width="labelWidth">
                        <el-input v-model="form.accountNumber" autocomplete="off" disabled="true"></el-input>
                    </el-form-item>
                    <el-form-item label="Name" :label-width="labelWidth">
                ...
                <el-button type="primary" @click="saveReceiver()">Submit</el-button>
            </div>
        </el-dialog>
    </div>
</template>
